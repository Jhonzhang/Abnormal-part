...
def load_data_mul2(load_data_tmp_name,over_load = False):
    ...
    if over_load:
        ...
        for each_block_index in range(len(data_traffic)):
            ...
            each_merge_data_pd_filled = each_merge_data_pd.fillna(each_merge_data_pd.mean())#使用均值填充nan值
            all_data.append(each_merge_data_pd_filled.values)
...
def load_data_mul_abnormal2(load_data_tmp_name,over_load = False):
...
if __name__ == "__main__":
    # 1 normal part
    load_data_tmp_name = 'normal_dataset_np'
    all_data_pd2, durations,N= load_data_mul2(load_data_tmp_name,over_load=True)
    print(durations)
    
    # 2 adnormal part
    load_data_tmp_name_abnormal = 'abnormal_dataset_np'
    all_data_pd_abnormal, duration_abnormal,N = load_data_mul_abnormal2(load_data_tmp_name_abnormal,over_load=True)
